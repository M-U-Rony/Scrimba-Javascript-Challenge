Your Task is apply some basic UI design to fix how this looks.

Strech goals:

1. Make the calender more interactive clicking each day could 'open' the day.
2. Every day that is open displays a random christmas gift(or chocolate?) in the box.
3. Save the state of the calender in Localstorage. 
